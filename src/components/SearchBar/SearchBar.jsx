...
const SearchBar = ({ placeholders, searchValue, setSearchValue }) => {
    ...
    return (
        <div className="relative w-full lg:w-1/3 border border-gray-300 rounded-lg">
            <CiSearch
                className="absolute left-4 top-1/2  transform -translate-y-1/2 text-gray-400 text-[1.5rem]" />
            ...
            <input
                ...
                className="w-full py-3.5 dark:bg-transparent rounded-lg outline-none pr-3 pl-12"
            />
